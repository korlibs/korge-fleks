 ...
 * created and added to the [KorgeViewSystem]. This is done in [onViewFamilyAdded] family hook here rather than in
 * component hook because we are sure that all needed components are set up before in the [World].
 */
fun viewFamily(): Family = World.family { all(ViewTag, PositionComponent, SizeComponent) }

val onViewFamilyAdded: FamilyHook = { entity ->
