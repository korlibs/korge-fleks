...
// Applied changes for using KorIO Json in Korge-Fleks
// Needs to be upstreamed if accepted
...
object Json {
    ...
    var stringifyPlugin: ((obj: Any?, b: StringBuilder) -> Boolean)? = null
    var stringifyPrettyPlugin: ((obj: Any?, b: Indenter) -> Boolean)? = null
    ...
    fun stringify(obj: Any?, b: StringBuilder) {
        when (obj) {
            ...
            is CustomSerializer -> obj.encodeToJson(b)
                ...
                if (stringifyPlugin?.invoke(obj, b) == false) invalidOp("Don't know how to serialize $obj")
    ...
    fun stringifyPretty(obj: Any?, b: Indenter) {
        when (obj) {
            ...
            is CustomSerializer -> b.inline(StringBuilder().apply { obj.encodeToJson(this) }.toString())
                ...
                if (stringifyPrettyPlugin?.invoke(obj, b) == false) invalidOp("Don't know how to serialize $obj")
                //encode(ClassFactory(obj::class).toMap(obj), b)
            }
        }
    }
